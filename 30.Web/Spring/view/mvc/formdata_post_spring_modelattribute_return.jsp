...
<html>
	<head>
		<meta charset="UTF-8">
		<title>formdata post spring modelattribute return 해슴!</title>
	</head>
	<body>
		<h3>formdata post spring modelattribute return 해슴!</h3>
		<hr>
		...
		<%
			...
			logger.info("	formdata_get_spring_return.jsp 해슴!	>>> : " + "<br>");
		...
		<%
			...
			System.out.println("	formdata_post_spring_modelattribute_return.jsp 의 fdvo 는 ?	>>> : " + fdvo);		
			out.println("	formdata_post_spring_modelattribute_return.jsp 의 fdvo 는 ?	>>> : " + fdvo + "<br>");	
