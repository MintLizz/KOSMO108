...
public class FileUploadUtil {
	...
	public boolean imgfileUploadSize(HttpServletRequest req, String filePath) {
		...
		try {
			...
			mr = new MultipartRequest(req, filePath, imgfileSize, encodeType, new FileRename());
			System.out.println("mr >>> : " + mr);
			System.out.println("mr.getOriginalFileName(\"kpimage\") >>> : " + mr.getOriginalFileName("kpimage"));
			System.out.println("mr.getFilesystemName(\"kpimage\") >>> : " + mr.getFilesystemName("kpimage"));
			
			ThumnailImg.thumnailFun(filePath, mr.getFilesystemName("kpimage"));	
